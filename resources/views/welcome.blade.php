    ...
    <nav class="navbar navbar-expand-lg navbar-dark navbar-custom fixed-top">
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarsExampleDefault">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link page-scroll" href="#video" id="navbarDropdown" role="button"
                            aria-haspopup="true" aria-expanded="false">TUTORIAL PENYEWAAN</a>
                    </li>
                    <li class="nav-item">
                ...
                <span class="nav-item">
                    <a class="btn-outline-sm" href="register">BUAT AKUN</a>
                </span>
            </div>
                    ...
                    <div class="col-lg-6 col-xl-7">
                        <div class="image-container">
                            <div class="img-wrapper">
                                <img class="img-fluid" src="images/motor1.webp" alt="alternative" height="1000px"
                                    width="1000px">
                ...
                @if (isset($dataKendaraan))
                    @forelse ($dataKendaraan as $item)
                        <div class="card w-20 h-50">
                            ...
                            <div class="card-body">
                                <h4 class="card-title">{{ $item->tipe_kendaraan }}</h4>
                                <p>Harga : <b>Rp {{ number_format($item->harga_sewa, 0, ',', '.') }}</b> / Hari</p>
                            </div>
                        </div>
                    @empty
