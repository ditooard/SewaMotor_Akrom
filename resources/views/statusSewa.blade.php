                                                        ...
                                                        @foreach ($dataSewa as $s)
                                                            <tr role="row">
                                                                ...
                                                                <th class="sorting" tabindex="0"
                                                                    ...
                                                                    colspan="1"
                                                                    aria-label="Age: activate to sort column ascending"
                                                                    style="width: 30.2px;">{{ \Carbon\Carbon::parse($s->mulai_sewa)->isoFormat('dddd, DD/MM/YYYY') }}</th>
                                                                <th class="sorting" tabindex="0"
                                                                    aria-controls="dataTable" rowspan="1"
                                                                    colspan="1"
                                                                    aria-label="Start date: activate to sort column ascending"
                                                                    style="width: 68.2px;">{{ \Carbon\Carbon::parse($s->selesai_sewa)->isoFormat('dddd, DD/MM/YYYY') }}</th>
                                                                <th class="sorting" tabindex="0"
                                                                    aria-controls="dataTable" rowspan="1"
                                                                    colspan="1"
                                                                    aria-label="Start date: activate to sort column ascending"
                                                                ...
                                                                <th class="sorting" tabindex="0"
                                                                    ...
                                                                    colspan="1"
                                                                    aria-label="Start date: activate to sort column ascending"
                                                                    style="width: 68.2px;">{{ \Carbon\Carbon::parse($s->tanggal_kembali)->isoFormat('dddd, DD/MM/YYYY') }}
                                                                </th>
                                                                <th class="sorting" tabindex="0"
                                                                    aria-controls="dataTable" rowspan="1"
                                                                    colspan="1"
